...
class CleverTapPlugin {
  ...
  void setCleverTapProfileSyncHandler(CleverTapProfileSyncHandler handler) => cleverTapProfileSyncHandler = handler;
  ...
  static Future<void> createNotificationChannel(
      String channelId, String channelName, String channelDescription, int importance, bool showBadge) async {
  ...
  static Future<void> createNotificationChannelWithGroupIdAndSound(String channelId, String channelName,
      String channelDescription, int importance, String groupId, bool showBadge, String sound) async {
    return await _channel.invokeMethod('createNotificationChannelWithGroupId', {
      'channelId': channelId,
      'channelName': channelName,
      'channelDescription': channelDescription,
  ...
  static Future<void> pushNotificationClickedEvent(Map<String, dynamic> extras) async {
    return await _channel.invokeMethod('pushNotificationClickedEvent', {'notificationData': extras});
  }

  ///Record Notification Viewed event
  static Future<void> pushNotificationViewedEvent(Map<String, dynamic> extras) async {
    return await _channel.invokeMethod('pushNotificationViewedEvent', {'notificationData': extras});
  }
  ...
  static Future<void> pushInstallReferrer(String source, String medium, String campaign) async {
    return await _channel
        .invokeMethod('pushInstallReferrer', {'source': source, 'medium': medium, 'campaign': campaign});
  }
  ...
  static Future<Map<String, bool>> getMapOfBooleanVariable(String name, Map<String, bool> defaultValue) async {
    Map<dynamic, dynamic> response =
        await _channel.invokeMethod('getMapOfBooleanVariable', {'name': name, 'defaultValue': defaultValue});
  ...
  static Future<Map<String, double>> getMapOfDoubleVariable(String name, Map<String, double> defaultValue) async {
    Map<dynamic, dynamic> response =
        await _channel.invokeMethod('getMapOfDoubleVariable', {'name': name, 'defaultValue': defaultValue});
  ...
  static Future<Map<String, int>> getMapOfIntegerVariable(String name, Map<String, int> defaultValue) async {
    Map<dynamic, dynamic> response =
        await _channel.invokeMethod('getMapOfIntegerVariable', {'name': name, 'defaultValue': defaultValue});
  ...
  static Future<Map<String, String>> getMapOfStringVariable(String name, Map<String, String> defaultValue) async {
    Map<dynamic, dynamic> response =
        await _channel.invokeMethod('getMapOfStringVariable', {'name': name, 'defaultValue': defaultValue});
